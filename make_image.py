...
VERSIONS = {
    "python": [
        ...
        },
        {
            ...
            "args": {
                "base_image": "ghcr.io/hyperledger/aries-cloudagent-python:py3.9-indy-1.16.0-0.9.0"
            },
        },
        {
            "version": "0.10.1",
            "dockerfile": "Dockerfile.mirror",
            "args": {
                "base_image": "ghcr.io/hyperledger/aries-cloudagent-python:py3.9-indy-1.16.0-0.10.1"
            },
        },
        {
            "version": "0.10.2",
            "dockerfile": "Dockerfile.mirror",
            "args": {
                "base_image": "ghcr.io/hyperledger/aries-cloudagent-python:py3.9-indy-1.16.0-0.10.2"
            },
        },
        {
            "version": "0.10.3",
            "dockerfile": "Dockerfile.mirror",
            "args": {
                "base_image": "ghcr.io/hyperledger/aries-cloudagent-python:py3.9-indy-1.16.0-0.10.3"
            },
        },
        {
            "version": "0.10.4",
            "dockerfile": "Dockerfile.mirror",
            "args": {
                "base_image": "ghcr.io/hyperledger/aries-cloudagent-python:py3.9-indy-1.16.0-0.10.4"
            },
        },
        {
            "version": "0.11.0",
        ...
        },
        {
            ...
            "dockerfile": "Dockerfile.mirror",
            "args": {
                "base_image": "ghcr.io/hyperledger/aries-cloudagent-python:py3.9-indy-1.16.0-0.11.1"
            },
        },
        {
            "version": "0.11.2",
            "dockerfile": "Dockerfile.mirror",
            "args": {
                "base_image": "ghcr.io/hyperledger/aries-cloudagent-python:py3.9-indy-1.16.0-0.11.2"
            },
        },
        {
            "version": "0.11.3",
        ...
        },
        {
            ...
            "dockerfile": "Dockerfile.mirror",
            "args": {
                "base_image": "ghcr.io/hyperledger/aries-cloudagent-python:py3.9-indy-1.16.0-0.12.1"
            },
        },
        {
            "version": "0.12.2",
